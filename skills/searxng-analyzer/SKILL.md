...
## Description
This skill analyzes SearXNG search results by fetching content from detailed list URLs, extracting key details, and summarizing the information using qwen3-max in markdown format.
...
## Usage Instructions
Provide SearXNG search results to analyze. The skill will process the results, fetch content from URLs in the detailed list, extract information, and return a summary in markdown format.
